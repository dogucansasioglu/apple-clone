...
import PromoCheckoutButton, {
  IPromoCheckoutButton,
} from '../PromoCheckoutButton';

export default {
  title: 'features/Promo/PromoCheckoutButton',
  component: PromoCheckoutButton,
  // More on argTypes: https://storybook.js.org/docs/react/api/argtypes
  argTypes: {},
} as ComponentMeta<typeof PromoCheckoutButton>;

// More on component templates: https://storybook.js.org/docs/react/writing-stories/introduction#using-args
const Template: ComponentStory<typeof PromoCheckoutButton> = (args) => (
  <div className="bg-promo p-5">
    <PromoCheckoutButton {...args} />
  </div>
);
